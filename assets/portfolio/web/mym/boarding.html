	...
	<div class="wrapper">
		...
		<div class="container clearfix"> <!-- Content Container -->
			...
			<div class="logo_holder">
				<object data="img/boarding.svg" type="image/svg+xml" class="circle_logos"></object>
			</div>

			<div id="group_txt"> 
				<h1>Boarding: 45.00 +HST per night</h1>
				<h3>We’re happy to offer boarding services to our regular walking clients.  This isn’t a cold kennel where the dogs are left alone all night.  Our walkers take on one or two dogs into their homes and treat them like they would their own. They’ll be given one group trail walk per day and as much TLC as they can handle!</h3>
			</div>

			 <!-- END OF CONTENT -->
				
			<div class="grid_12 omega " id="bottom_text"> 
