...
<body>
	...
	<div class="wrapper">
		...
		<div class="container clearfix"> <!-- Content Container -->
			...
			<div id="circle_logos" class="grid_12" style="border: none; padding-bottom: 5%;">

					
				<div id="group_walks" class="services_logos"> <!-- Group Walks Logo DIV-->
				...
				<div id="puppy_visits" class="services_logos">
				...
				<div id="boarding" class="services_logos">
			...
			</div> <!-- END OF CONTENT LOGOS DIV -->

			<div id="services_txt">
				<h2>Click on a service to see more info!</h2>
	 		</div>
			 <!-- END OF CONTENT -->
