...
<body>
	...
	<div class="wrapper">
		...
		<div class="container clearfix"> <!-- Content Container -->
			...
			<a href="index.php" title="Home"><div id="header-img" data-picture data-alt="Mind You Manners Header">
			...
			<div id="walkers" class="grid_3"> 
				<a href="http://followtheleaderinc.com" target="blank"><img src="img/ftl.png" alt="Follow the Leader link"></a>
			</div>


			<div id="content_logos" class="grid_12">
