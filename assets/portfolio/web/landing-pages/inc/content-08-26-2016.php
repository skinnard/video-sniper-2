    ...
    <?php } ?>
      ...
      <div class="inner">
        ...
        <div>
          ...
          <p>Only <?php echo $remaining ?> more are needed to unlock this exclusive group offer on the fastest Internet technology &ndash; with speeds of 940 Mbps<sup>1</sup> &ndash;<?php if ($offer != "triple") { ?> and<?php } ?> the best TV&nbsp;service<?php if ($offer == "triple") { ?> and our reliable Home&nbsp;phone&nbsp;service<?php } ?>.</p>
