      ...
      <div id="main-left">
        ...
        ********************************************************************************************* -->
        ...
        <ul class='category-01'>
          <li><a href='HTMLemails/en_.php?cc=1A1E&f=en_.php&l=en&ppv=99'>1A1E <span class='arrow'>&#9658;</span></a>
            <input class="send-test-btn" type='button' value='Send Test' onClick="validate('1A1E','en_.php')" />
          </li>
          <li><a href='HTMLemails/en_.php?cc=3A1E&f=en_.php&l=en&ppv=99'>4A1E <span class='arrow'>&#9658;</span></a>
            <input class="send-test-btn" type='button' value='Send Test' onClick="validate('3A1E','en_.php')" />
          </li>
          <li><a href='HTMLemails/en_.php?cc=1B1E&f=en_.php&l=en&ppv=99'>1B1E <span class='arrow'>&#9658;</span></a>
        ...
        <ul class='category-02'>
         <li><a href='HTMLemails/fr_.php?cc=1A1F&f=fr_.php&l=fr&ppv=99'>1A1F <span class='arrow'>&#9658;</span></a>
            <input class="send-test-btn" type='button' value='Send Test' onClick="validate('1A1F','fr_.php')" />
          </li>
          <li><a href='HTMLemails/fr_.php?cc=3A1F&f=fr_.php&l=fr&ppv=99'>4A1F <span class='arrow'>&#9658;</span></a>
            <input class="send-test-btn" type='button' value='Send Test' onClick="validate('3A1F','fr_.php')" />
          </li>
          <li><a href='HTMLemails/fr_.php?cc=1B1F&f=fr_.php&l=fr&ppv=99'>1B1F <span class='arrow'>&#9658;</span></a>
