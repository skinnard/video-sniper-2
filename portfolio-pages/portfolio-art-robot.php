        ...
        <a href="#" class="logo hidden-xs hidden-sm"><img src="../assets/images/logo.png" width="35" height="35" alt="Logo" /></a>
          <div class="portfolio-single">
            <div class="project-details">
              <h4 class="wow fadeInLeft"  data-wow-delay=".1s">ART</h4>
              <h1 class="wow fadeInLeft" data-wow-delay=".2s">Love bot</h1>
              <p class="wow fadeInLeft" data-wow-delay=".3s">
                Digital illustration. Photoshop and illustrator used in creation. 
              </p>
            <div class="project-images wow fadeInLeft"  data-wow-delay=".4s">
              <img src="../assets/portfolio/art/robot.jpg" alt="project image" />
            </div>
