    ...
    <section class="split-home">
      ...
      <section class="right-section">
        ...
        <div class="split-about">
          <div class="split-about-details">
            <h4 class="wow fadeInLeft"  data-wow-delay=".1s">About</h4>
            ...
            <div class="split-about-experience">
						...
						<ul>
							...
							<li>
								<h3>Carpenter</h3>
								<p>
									I worked with my hands for some years out of college. Its still something I love but the pull of the web was too strong.
								</p>
								<h6>2008 - 2014</h6>
							</li>
							<li>
								<h3>Degree in Media Arts - Sheridan College</h3>
								<p>
									Learned all things film with a focus on post production.
								</p>
								<h6>2004 - 2008</h6>
							</li>
						</ul>
					</div>
          <h2>Have a great plan that <br class="hidden-xs"> needs a developer?</h2>
          <a class="btn-contact" href="contact.php">Hire Me</a>
          </div>
        </div>
